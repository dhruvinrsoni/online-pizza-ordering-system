...
INSERT INTO `order_items` (`Order_Item_Id`,`Order_Id`,`Price`,`Name`) VALUES 
 (1,1,'350','Chicken Fiesta'),
 (2,1,'250','Farmhouse'),
 (3,2,'150','Margherita'),
 (4,2,'200','Veggie Feast');
...
INSERT INTO `payment` (`Payment_Id`,`Order_Id`,`Payment_Mode`,`Payment_Time`,`Payment_Status`) VALUES 
 (1,1,'Net Banking','201907161930','Completed'),
 (2,2,'Cash','201907172000','Pending');
