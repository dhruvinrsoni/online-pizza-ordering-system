...
<html ng-app="app">
    <head>
      ...
      <body>
        <div style="background: white; margin:-10px; position: fixed;height:100%; width:110%;background-size:auto,cover;
background-position:top left, center;background-image: linear-gradient(rgba(0,0,0,.3),rgba(0,0,0,.6)), url(static/images/la_piazza.jpg);">
            ...
            <div style="float: right; margin-right: 10%;">
              <ul>
                <li ng-hide="$localStorage.email"><a href="#/end">Logout</a></li>
