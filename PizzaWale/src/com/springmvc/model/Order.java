...
public class Order {
	...
	public String toString() {
		return "Order [ordereditems=" + ordereditems + ", margherita="
				+ margherita + ", dcmargherita=" + dcmargherita
				+ ", farmhouse=" + farmhouse + ", deluxeveggie=" + deluxeveggie
				+ ", mexgw=" + mexgw + ", peppypan=" + peppypan + ", name="
				+ name + ", address=" + address + ", mobileNum=" + mobileNum
				+ ", email=" + email + "]";
	}
